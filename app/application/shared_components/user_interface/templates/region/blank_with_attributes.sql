...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11940492061135266434)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940492360794266434)
,p_plug_template_id=>wwv_flow_imp.id(11940492061135266434)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940492681027266434)
,p_plug_template_id=>wwv_flow_imp.id(11940492061135266434)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940492932685266434)
,p_plug_template_id=>wwv_flow_imp.id(11940492061135266434)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940493255960266434)
,p_plug_template_id=>wwv_flow_imp.id(11940492061135266434)
,p_name=>'Sub Regions'
