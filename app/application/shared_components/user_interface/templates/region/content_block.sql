...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11940520771175266446)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940521029682266446)
,p_plug_template_id=>wwv_flow_imp.id(11940520771175266446)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940521367686266446)
,p_plug_template_id=>wwv_flow_imp.id(11940520771175266446)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940521636271266446)
,p_plug_template_id=>wwv_flow_imp.id(11940520771175266446)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940521973417266446)
,p_plug_template_id=>wwv_flow_imp.id(11940520771175266446)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940522254961266447)
,p_plug_template_id=>wwv_flow_imp.id(11940520771175266446)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940522580084266447)
,p_plug_template_id=>wwv_flow_imp.id(11940520771175266446)
,p_name=>'Sub Regions'
