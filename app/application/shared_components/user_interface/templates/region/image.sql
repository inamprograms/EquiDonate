...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11940528841215266450)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940529149533266450)
,p_plug_template_id=>wwv_flow_imp.id(11940528841215266450)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940529473162266450)
,p_plug_template_id=>wwv_flow_imp.id(11940528841215266450)
,p_name=>'Sub Regions'
