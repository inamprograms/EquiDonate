...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11940568459174266466)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940568750943266467)
,p_plug_template_id=>wwv_flow_imp.id(11940568459174266466)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940569099570266467)
,p_plug_template_id=>wwv_flow_imp.id(11940568459174266466)
,p_name=>'Tabs'
