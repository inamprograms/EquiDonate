...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11940548865985266458)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940549158173266458)
,p_plug_template_id=>wwv_flow_imp.id(11940548865985266458)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940549416968266458)
,p_plug_template_id=>wwv_flow_imp.id(11940548865985266458)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940549739551266458)
,p_plug_template_id=>wwv_flow_imp.id(11940548865985266458)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940550063418266459)
,p_plug_template_id=>wwv_flow_imp.id(11940548865985266458)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940550372909266459)
,p_plug_template_id=>wwv_flow_imp.id(11940548865985266458)
,p_name=>'Sub Regions'
