...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11940555972291266461)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940556203686266461)
,p_plug_template_id=>wwv_flow_imp.id(11940555972291266461)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940556503061266461)
,p_plug_template_id=>wwv_flow_imp.id(11940555972291266461)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940556885254266462)
,p_plug_template_id=>wwv_flow_imp.id(11940555972291266461)
,p_name=>'Sub Regions'
