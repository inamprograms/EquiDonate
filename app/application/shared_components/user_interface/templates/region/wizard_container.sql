...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11940576187033266470)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940576414709266470)
,p_plug_template_id=>wwv_flow_imp.id(11940576187033266470)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940576742712266470)
,p_plug_template_id=>wwv_flow_imp.id(11940576187033266470)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940577014467266470)
,p_plug_template_id=>wwv_flow_imp.id(11940576187033266470)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940577332857266470)
,p_plug_template_id=>wwv_flow_imp.id(11940576187033266470)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940577675519266470)
,p_plug_template_id=>wwv_flow_imp.id(11940576187033266470)
