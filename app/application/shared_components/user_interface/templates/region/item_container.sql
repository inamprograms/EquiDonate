...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11940550950037266459)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940551228796266459)
,p_plug_template_id=>wwv_flow_imp.id(11940550950037266459)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940551564592266459)
,p_plug_template_id=>wwv_flow_imp.id(11940550950037266459)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940551867462266459)
,p_plug_template_id=>wwv_flow_imp.id(11940550950037266459)
,p_name=>'Button Start'
