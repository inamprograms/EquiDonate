...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11940525366837266448)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940525627100266448)
,p_plug_template_id=>wwv_flow_imp.id(11940525366837266448)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940525905241266449)
,p_plug_template_id=>wwv_flow_imp.id(11940525366837266448)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940526259334266449)
,p_plug_template_id=>wwv_flow_imp.id(11940525366837266448)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940526566351266449)
,p_plug_template_id=>wwv_flow_imp.id(11940525366837266448)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940526865219266449)
,p_plug_template_id=>wwv_flow_imp.id(11940525366837266448)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
