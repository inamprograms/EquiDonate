...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11940553439098266460)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940553724502266460)
,p_plug_template_id=>wwv_flow_imp.id(11940553439098266460)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940554001538266460)
,p_plug_template_id=>wwv_flow_imp.id(11940553439098266460)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940554328677266460)
,p_plug_template_id=>wwv_flow_imp.id(11940553439098266460)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940554646025266461)
,p_plug_template_id=>wwv_flow_imp.id(11940553439098266460)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940554938590266461)
,p_plug_template_id=>wwv_flow_imp.id(11940553439098266460)
,p_name=>'Sub Regions'
