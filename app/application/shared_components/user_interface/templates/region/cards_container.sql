...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11940499152166266436)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940499474870266436)
,p_plug_template_id=>wwv_flow_imp.id(11940499152166266436)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940499727204266437)
,p_plug_template_id=>wwv_flow_imp.id(11940499152166266436)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940500071822266437)
,p_plug_template_id=>wwv_flow_imp.id(11940499152166266436)
,p_name=>'Sub Regions'
