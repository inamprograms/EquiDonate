...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11940493406731266434)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940493774208266434)
,p_plug_template_id=>wwv_flow_imp.id(11940493406731266434)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940494012575266434)
,p_plug_template_id=>wwv_flow_imp.id(11940493406731266434)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940494374131266434)
,p_plug_template_id=>wwv_flow_imp.id(11940493406731266434)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940494613021266435)
,p_plug_template_id=>wwv_flow_imp.id(11940493406731266434)
,p_name=>'Sub Regions'
