...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11940456100323266417)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940456456563266417)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940456761825266418)
,p_page_template_id=>wwv_flow_imp.id(11940456100323266417)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940457059162266418)
,p_page_template_id=>wwv_flow_imp.id(11940456100323266417)
