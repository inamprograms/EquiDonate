...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11940485301423266430)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940485646470266430)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940485965170266430)
,p_page_template_id=>wwv_flow_imp.id(11940485301423266430)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940486280287266431)
,p_page_template_id=>wwv_flow_imp.id(11940485301423266430)
