...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11940476742792266426)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940477099097266427)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940477321221266427)
,p_page_template_id=>wwv_flow_imp.id(11940476742792266426)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940477610581266427)
,p_page_template_id=>wwv_flow_imp.id(11940476742792266426)
