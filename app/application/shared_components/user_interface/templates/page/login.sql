...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11940466771875266422)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940467027951266423)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940467361440266423)
,p_page_template_id=>wwv_flow_imp.id(11940466771875266422)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940467636122266423)
,p_page_template_id=>wwv_flow_imp.id(11940466771875266422)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11940467977809266423)
,p_page_template_id=>wwv_flow_imp.id(11940466771875266422)
,p_name=>'Body Footer'
